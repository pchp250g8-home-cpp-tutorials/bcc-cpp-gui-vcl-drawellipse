DrawEllipse. Embarcadero Rad Studio IDE. VCL. 2D Graphics. GDI. GUI Application. 
The program does the following:
   ...
   3. In the client area of ​​the dialog box, draws a yellow ellipse (oval) with a red outline of 5 pixels thick and
...
DrawEllipse. Занятия по C++. ИС Embarcadero Rad Studio. Библиотека VCL. 2D Графика. GDI. 
